...
<nav class="navbar fixed-top navbar-dark navbar-expand bg-dark">
    <ul class="nav navbar-nav">
        ...
        <form class="form-inline" method="POST" >
            ...
            <button type="submit" onclick='this.form.action="authorization";' class="b1">Sign in</button>
            <button type="submit" onclick='this.form.action="registry";' class="b2">Registy</button></form>
