<%@ page import="ru.kravchenko.spring.entity.Project" %>
...
<c:forEach var="project" items="${projects}" varStatus="status">
    <tr>
        ...
        <td align="center" nowrap="nowrap">
            <a href="${pageContext.request.contextPath}/project-view/${project.id}">VIEW</a>
        </td>

        <td align="center" nowrap="nowrap">
        <a href="${pageContext.request.contextPath}/project-edit/${project.id}">EDIT </a>
        </td>
        <td align="center" nowrap="nowrap">
        <a href="${pageContext.request.contextPath}/project-delete/${project.id}">REMOVE </a>
        </td>
    </tr>
</c:forEach>
